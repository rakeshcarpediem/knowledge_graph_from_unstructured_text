...
def main():
    ...
    for file in pickles:
        ...
        processed_pd.to_csv('/content/knowledge_graph_from_unstructured_text/data/output/result/' + file.split("/")[-1].split(".")[0] + '.csv', encoding='utf-8', index=False, error_bad_lines=False)
